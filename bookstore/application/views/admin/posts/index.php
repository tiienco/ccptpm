...
<div class='box'>
	<div class='box-header with-border' style='padding: 5px 10px;'>
		<button type="button" class="btn btn-primary btn-sm" onclick="window.location='<?php echo BASE_URL_ADMIN ?>posts/add'">
			<i class="fa fa-plus-circle" aria-hidden="true" style=''></i> <b>Tạo mới</b>
		</button>
		<button id='delete' data-id='' class="btn btn-default btn-sm pull-right" onclick='deleteID(this,"posts/delete")'>Xóa Yêu cầu</button>
	</div>
	<div class='box-body'>
		<table class="table table-striped table-bordered datatables table-posts">
		    <thead>
		        <tr>
		    ...
		    <?php foreach($_data as $key =>  $d): ?>
		    	<tr>
		           	...
		           	<td><img src="<?php echo BASE_UPLOAD.'posts/'.$d['image'] ?>" style="width: 100px;"></td>
		            <td><a href='<?php echo BASE_URL_ADMIN."posts/add/".$d['id'] ?>'><?php echo $d['title']?></a></td>			            
		            ...
		            <td class='text-center'>
		            	<i class="fa fa-trash-o delete-record" onclick='deleteOne(this,<?php echo $d['id']?>,"posts/delete")'></i>
		            </td>
