...
<div class='box'>
	...
	<div class='box-body'>
		<form class="form-horizontal" action='<?php echo BASE_URL_ADMIN."config/description"?>' method='POST'>
            <div class="form-group">
				<label for="inputEmail3" class="col-sm-2">Nội dung</label>
				<div class="col-sm-10">
					<textarea name="description" class="form-control ckeditor" rows="6" placeholder="Footer"><?php echo @$_data['value']?></textarea>
				</div>				
            </div>
