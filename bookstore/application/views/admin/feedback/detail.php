...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Thêm feedback</li>
	</ol>
</section>
...
<div class='box'>
	<div class='box-header with-border' style='padding: 5px 10px;'>
		...
		<button type="button" class="btn btn-default btn-sm" onclick="window.location='<?php echo BASE_URL_ADMIN ?>feedback'">
			<i class="fa fa-reply" aria-hidden="true"></i> <b>Quay lại</b>
		</button>

		<?php if(@$_detail): ?>
		<button type="button" class="btn btn-primary btn-sm" onclick="window.location='<?php echo BASE_URL_ADMIN ?>feedback/add'">
		<i class="fa fa-plus-circle" aria-hidden="true" style=''></i> <b>Tạo mới</b>
		</button>
		<?php endif; ?>
	</div>
	<div class='box-body'>
		<form class="form-horizontal" action='<?php echo BASE_URL_ADMIN."feedback/add/".@$_detail['id'] ?>' method='POST' enctype="multipart/form-data">
            ...
            <div class="form-group">
				...
				<div class="col-sm-10">
					<textarea name="content" class="form-control" rows="3" required="required"><?php echo @$_detail['content']?></textarea>				
				</div>
            </div>
            <div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class='box-img' style='width: 150px;height: 150px;'>
						...
						<img style='max-width: 100%;width: 150px;height: 150px;object-fit: cover;object-position: 50% 50%;' src='<?php echo BASE_UPLOAD."feedback/".$_detail['image'] ?> '>
					</div>
					<?php endif; ?>
