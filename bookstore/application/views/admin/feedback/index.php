...
<div class='box'>
	<div class='box-header with-border' style='padding: 5px 10px;'>
		...
		<button id='delete' data-id='' class="btn btn-default btn-sm pull-right" onclick='deleteID(this,"feedback/delete")'>Xóa Yêu cầu</button>
	</div>
	<div class='box-body'>
		<table class="table table-striped table-bordered datatables table-feedback">
		    <thead>
		        <tr>
		    ...
		    <?php foreach($_data as $key =>  $d): ?>
		    	<tr>
		           	...
		           	<td><img src="<?php echo BASE_UPLOAD.'feedback/'.$d['image'] ?>" style="width: 50px;"></td>
		            <td><a href='<?php echo BASE_URL_ADMIN."feedback/add/".$d['id'] ?>'><?php echo $d['title']?></a></td>			            
		            ...
		            <td class='text-center'>
		            	<i class="fa fa-trash-o delete-record" onclick='deleteOne(this,<?php echo $d['id']?>,"feedback/delete")'></i>
		            </td>
