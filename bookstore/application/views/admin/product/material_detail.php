...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Thêm chất liệu</li>
	</ol>
</section>
...
<div class='box'>
	<div class='box-header with-border' style='padding: 5px 10px;'>
		...
		<button type="button" class="btn btn-default btn-sm" onclick="window.location='<?php echo BASE_URL_ADMIN."product/material_index"?>'">
			<i class="fa fa-reply" aria-hidden="true"></i> <b>Quay lại</b>
		</button>
	
		<?php if(@$_detail): ?>
		<button type="button" class="btn btn-success btn-sm" onclick="window.location='<?php echo BASE_URL_ADMIN."product/material_add/" ?>'">
		<i class="fa fa-plus-circle" aria-hidden="true" style=''></i> <b>Tạo mới</b>
		</button>
		<?php endif; ?>
	</div>
	<div class='box-body'>
		<form class="form-horizontal" action='<?php echo BASE_URL_ADMIN."product/material_add/".@$_detail['id'] ?>' method='POST' enctype="multipart/form-data">			
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2">Chất liệu</label>
				<div class="col-sm-8">
					<input type="text" name="title" class='form-control <?php echo (!@$_detail)?'title_alias':''; ?>' placeholder="Chất liệu" value="<?php echo @$_detail['title'] ?>">				
				</div>
				<div class="col-sm-2">					
